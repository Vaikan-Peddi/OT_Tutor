...
Usage:
    ...
    python run_eval.py --ragas      # also run RAGAS (requires eval_results/eval_transcripts.json)
...
def main():
    ...
    parser.add_argument("--retrieval", action="store_true", help="Also run Retrieval quality eval")
    ...
    if args.ragas:
        ...
        if not transcripts_path.exists():
            print("\n[RAGAS] eval_results/eval_transcripts.json not found — skipping RAGAS eval.")
            print("  Export session transcripts from your tutor runs and save as eval_results/eval_transcripts.json.")
        else:
